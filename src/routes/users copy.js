...
router.post('/', async (req, res) => {
    ...
    try {
        const result = await pool.query('INSERT INTO users (username, password, email_address) VALUES ($1, $2, $3) RETURNING *', [username, password, email_address])
        ...
        await sendVerificationEmail(email_address, result.rows[0].id, username, random_token)
